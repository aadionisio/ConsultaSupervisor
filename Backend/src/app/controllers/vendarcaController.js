import vendarca from "../models/vendarca";
...
async function index(req, res) {
  ...
  context.codsuperv = req.params.codsuperv;

  console.log("antes de executar a query");
  console.log(context);
  const vendas = await vendarca.query(context);
  //  console.log(user);
